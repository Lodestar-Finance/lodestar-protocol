...
/**
 * @title Lodestar's CEtherUpgradeable Contract
 * @notice CToken which wraps Ether and is upgradeable
 * @author Lodestar
 */
contract CEtherUpgradeable is CToken {
    /**
    ...
    function sweepToken(EIP20NonStandardInterface token) external {
        require(msg.sender == admin, "CEtherUpgradeable::sweepToken: only admin can sweep tokens");
