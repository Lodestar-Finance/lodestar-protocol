...
//forked from https://github.com/gnosis/util/blob/master/contracts/StorageAccessible.sol
...
abstract contract StorageAccessible {
     ...
     */
    function simulate(address targetContract, bytes memory calldataPayload) public returns (bytes memory response) {
