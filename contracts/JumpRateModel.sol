...
contract JumpRateModel is InterestRateModel {
     ...
     */
    constructor(uint baseRatePerYear, uint multiplierPerYear, uint jumpMultiplierPerYear, uint kink_) payable {
        uint256 _baseRatePerBlock = baseRatePerYear / blocksPerYear;
        baseRatePerBlock = _baseRatePerBlock;
        uint256 _multiplierPerBlock = multiplierPerYear / blocksPerYear;
