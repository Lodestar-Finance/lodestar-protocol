...
contract Comptroller is ComptrollerV9Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    /**
     * @notice Set the given supply caps for the given cToken markets. Minting that brings total supply to or above supply cap will revert.
     * @dev Admin or supplyCapGuardian function to set the supply caps. A supply cap of 0 corresponds to unlimited minting.
    ...
    function getCompAddress() public view virtual returns (address) {
        return 0x3a9384701a43C2b6932d8e2E6A25285695f52F75;
    }
}
