...
import "../../contracts/Oracle/Interfaces/FeedRegistryInterface.sol";
...
contract MockAggregator {
    string public constant description = "mock ETH denominated aggregator";
...
contract MockUSDAggregator {
    string public constant description = "mock USD denominated aggregator";
    uint256 public constant version = 1;
    uint80 public constant roundId = 1;
